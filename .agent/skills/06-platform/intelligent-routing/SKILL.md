...
### With kare.instructions.md Rules

- **Priority**: kare.instructions.md rules > intelligent-routing
- If kare.instructions.md specifies explicit routing, follow it
...
Add to kare.instructions.md temporarily:
...
**Next Steps**: Integrate this skill into kare.instructions.md TIER 0 rules.
