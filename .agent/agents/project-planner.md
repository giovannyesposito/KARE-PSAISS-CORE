...
model: inherit
skills: 02-downstream/clean-code, 03-architecture/app-builder, 03-architecture/plan-writing, 01-upstream/brainstorming, 04-governance/jira-assistant
---
...
python .agent/scripts/guards/verify_all.py . --url http://localhost:3000
