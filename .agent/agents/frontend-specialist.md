...
model: inherit
skills: 02-downstream/clean-code, 02-downstream/coding-guidelines, 03-architecture/frontend-design, 02-downstream/lint-and-validate
---
...
> **Note:** This agent loads relevant skills (clean-code, frontend-design, etc.) for detailed guidance. Apply behavioral principles from those skills rather than copying patterns.
